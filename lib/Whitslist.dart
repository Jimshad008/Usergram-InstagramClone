...
import 'package:task4/emptywish.dart';
...
class favourite extends StatefulWidget {
  ...
  favourite({super.key, required this.back, required this.fav,});
               ...
               if (c == 0) {
                 ...
                 wishList[index].isCarted=true;
                   ...
                   Container(
                     ...
                     height: w * 0.07,
                     decoration: BoxDecoration(
                         color: Color.fromRGBO(91, 47, 43, 100),
                 ...
                 child: InkWell(
                   onTap: () {
                     setState(() {
                       ...
                       if(wishList.isEmpty){
                         Navigator.push( context, MaterialPageRoute(builder: (context) => emptywish(),));
                       }
                     });
                   },
                   child: Container(
