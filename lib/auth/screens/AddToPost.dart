...
class _AddToPostState extends State<AddToPost> {
 ...
 Future<void> _uploadMediaToFirebase() async {
   try {
     ...
     var a=MediaModel(postDate:Timestamp.now(), image:downloadURL, description: description.text, uid: FirebaseAuth.instance.currentUser!.uid,likes: [], mid: '',comment: [],);
              ...
              children:[
                ...
                _pickedMedia != null
                  ...
                  child: ClipRRect(
                    ...
                    child: Container(
                      width: 300,
                      height: 300,
                      decoration: BoxDecoration(border: Border.all(color: Constant().secondary,width: 2)),
                      child: Image.file(
                        ...
                        child: InkWell(
                            onTap: () {
                              ...
                              child: Container(
                                 ...
                                 decoration: BoxDecoration(borderRadius: BorderRadius.circular(80),border: Border.all(color: Constant().secondary,width: 2)),



                                child: Icon(Icons.add,color:Constant().secondary,size: 40,),
                              ),
                        ),
                            )),
                ...
                InkWell(onTap: () {
                  ...
                  child: Container(
                    ...
                    child: Center(
                      child: Text("Add to Post",style: TextStyle(color: Constant().color,fontWeight: FontWeight.bold),),
                    ),
                  ),
                )
           ] ),
