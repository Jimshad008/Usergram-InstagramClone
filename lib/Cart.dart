...
import 'package:task4/checkout.dart';
import 'package:task4/list.dart';
...
class CartPage extends StatefulWidget {
  ...
  CartPage({super.key, required this.back});
      ...
      child: Row(
        ...
        children: [
          ...
          Column(
            ...
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text(cartList[index].itemName,style: TextStyle(fontWeight: FontWeight.bold),),
              Text("\$${cartList[index].itemPrice*(cartList[index].itemQuantity)}",style: TextStyle(fontWeight: FontWeight.bold,color: Colors.blueAccent)),
              Text(cartList[index].itemType,style: TextStyle(color: Colors.grey))
            ],
          ),
          Padding(
